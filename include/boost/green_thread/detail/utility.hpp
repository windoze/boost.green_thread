...
#ifndef BOOST_GREEN_THREAD_UTILITY_HPP
#define BOOST_GREEN_THREAD_UTILITY_HPP

#include <functional>
#include <tuple>
#include <type_traits>

namespace boost { namespace green_thread { namespace utility {
...
}}} // End of namespace boost::green_thread::utility
